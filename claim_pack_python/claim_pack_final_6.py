...
def main():
    ...
    for supp_num,list_pmt_id in dict_sup_pro.items():
        ...
        for pmt_id in list_pmt_id:
            ...
            elif float(df_splited['ELI_V3_FINAL'].unique()[0]) < 100 :
                df_splited['CHECK_COLUMN'] = 'ELI_V3_FINAL < 100'
    ...
    df_raw_filter = df_raw_check[(df_raw_check['CHECK_COLUMN'] == 'TO QA_NATIONAL')]
