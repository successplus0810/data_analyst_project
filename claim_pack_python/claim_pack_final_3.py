...
def main():
                    ...
                    if flag_co :
                        ...
                        if flag_prgx:
                            ...
                            if df_check_prof.empty:
                                df_splited['CHECK_COLUMN_2'] = 'TO QA'
                                if df_splited['ELI'].sum() >= 100:
                                    df_splited['CHECK_COLUMN'] = 'TO QA'
                                else :
                                    df_splited['CHECK_COLUMN'] = 'ELI1 < 100'
                            else:
                                df_splited['CHECK_COLUMN'] = 'PROFECTUS CLAIMED'
                                df_splited['CHECK_COLUMN_2'] = 'PROFECTUS CLAIMED'
                        else:
                            df_splited['CHECK_COLUMN'] = 'PRGX'
                            df_splited['CHECK_COLUMN_2'] = 'PRGX'
                    else:
                        df_splited['CHECK_COLUMN'] = 'COLES ONLINE'
                        df_splited['CHECK_COLUMN_2'] = 'COLES ONLINE'
                else:
                    df_splited['CHECK_COLUMN'] = 'CHECK AGAIN'
                    df_splited['CHECK_COLUMN_2'] = 'CHECK AGAIN'
            if j  == 0:
    ...
    df_raw_filter = df_raw_check[(df_raw_check['CHECK_COLUMN'] == 'TO QA') | (df_raw_check['CHECK_COLUMN'] == 'PRGX')] 
